...
SECRET_KEY = 'django-insecure-t-1$#ipz7(+blfrnn%0n30s*pmfkck&@+qoo!6c^kt0ai#gbkm'
...
MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware',  # الحارس فوق خالص لحل مشكلة المتصفح بأمان
